...
CREATE INDEX idx_raid_group_members_char ON raid_group_characters(character_id);
CREATE INDEX idx_raid_group_members_group ON raid_group_characters(raid_group_id);
